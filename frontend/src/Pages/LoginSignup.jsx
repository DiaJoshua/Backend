...
const LoginSignup = () => {
  ...
  const checkboxHandler = () => {
   ...
   const sendOtp = async () => {
    ...
    try {
      const response = await fetch("https://ecommerce-web-puce.vercel.app/send-otp", {
        method: "POST",
  ...
  const verifyOtp = async () => {
    ...
    try {
      const response = await fetch("https://ecommerce-web-puce.vercel.app/verify-otp", {
        method: "POST",
        headers: { "Content-Type": "application/json" },
        body: JSON.stringify({
  ...
  const verifyOtpAndResetPassword = async () => {
    ...
    try {
      const response = await fetch("https://ecommerce-web-puce.vercel.app/reset-password", {
        method: "POST",
        headers: { "Content-Type": "application/json" },
        body: JSON.stringify({
          email: emailForReset,
    ...
    const sendPasswordResetEmail = async () => {
      ...
      try {
        const response = await fetch('https://ecommerce-web-puce.vercel.app/forgot-password', {
          method: 'POST',
          headers: { 'Content-Type': 'application/json' },
    ...
    const login = async () => {
      ...
      try {
        const response = await fetch('https://ecommerce-web-puce.vercel.app/login', {
          method: 'POST',
          headers: { 'Content-Type': 'application/json' },
          body: JSON.stringify({
            email: formData.email,
  ...
  const signup = async () => {
    ...
    let responseData;
    await fetch('https://ecommerce-web-puce.vercel.app/signup', {
      method:'POST',
      headers:{
