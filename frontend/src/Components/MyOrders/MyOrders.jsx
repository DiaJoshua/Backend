...
const updateTransactionStatus = async (transactionId, newStatus) => {
  try {
    const response = await fetch(
      `https://ecommerce-web-puce.vercel.app/api/transactions/updateTransactionStatus/${transactionId}`,
      {
        method: "POST",
        headers: {
    ...
    const fetchOrders = async () => {
      try {
        const response = await axios.get(
          `https://ecommerce-web-puce.vercel.app/api/transactions/userTransactions/${userId}`
        );
